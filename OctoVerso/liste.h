...
/**
 * @brief Initialise une liste comme étant vide. Pour éviter toute fuite mémoire, toute liste non vide doit être détruite lorsqu'elle ne sera plus utilisée (@ref detruireListe).
...
/**
 * @brief Itérateur sur une liste permettant d'obtenir un à un les éléments qui la composent mais pas de modifier cette liste.
...
/**
 * @brief Itérateur sur une liste permettant d'obtenir un à un les éléments qui la composent mais aussi de modifier cette liste (modification de la valeur de l'élément courant, insertion avant l'élément courant, suppression de l'élément courant).
 */
typedef struct {
